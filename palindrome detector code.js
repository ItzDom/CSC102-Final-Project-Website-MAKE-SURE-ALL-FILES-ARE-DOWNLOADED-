...
let palindromeCorrect = document.getElementById('palindromeCorrect');
let palindromeWrong = document.getElementById('palindromeWrong');

// Ensure the audio is loaded before attempting to play
palindromeCorrect.addEventListener('canplaythrough', () => console.log('Correct answer audio ready to play'));
palindromeWrong.addEventListener('canplaythrough', () => console.log('Wrong answer audio ready to play'));
